...
// ####################
        function render(gameState){
            ...
            // remove players that died
            // console.log(playersbmpMap);
            for(var i = 0; i < gameState.playersToRemove.length; i++){
                console.log("These are players to remove");
                console.log(gameState.playersToRemove);
                // console.log(playersbmpMap);
                stage.removeChild(playersbmpMap[gameState.playersToRemove[i]]);
                if (player.id == gameState.playersToRemove[i])
